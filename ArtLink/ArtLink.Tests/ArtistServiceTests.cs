...
public class ArtistServiceTests
{
    ...
    public async Task AddArtistAsync_CallsRepositoryWithCorrectParameters()
    {
        ...
        // Act
        await _artistService.AddArtistAsync(firstName, lastName, email, bio, profilePicturePath, experience);

        // Assert
        _artistRepositoryMock.Verify(r => r.AddAsync(
            firstName, lastName, email, bio, profilePicturePath, experience), Times.Once);
    }
