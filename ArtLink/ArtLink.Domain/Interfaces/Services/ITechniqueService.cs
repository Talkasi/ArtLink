...
/// <summary>
/// Defines the interface for managing techniques within the system.
/// </summary>
public interface ITechniqueService
{
    ...
    Task<Guid> AddTechniqueAsync(string name, string description);
    ...
    /// <returns>A task representing the asynchronous operation.</returns>
    Task UpdateTechniqueAsync(Guid id, string name, string description);
    ...
    /// <returns>A task representing the asynchronous operation.</returns>
    Task DeleteTechniqueAsync(Guid id);
}
