...
public interface IArtworkService
{
    ...
    /// The task result contains the <see cref="Artwork"/> if found; otherwise, <c>null</c>.
    /// </returns>
    ...
    /// <returns>
    /// A task that represents the asynchronous operation. 
    /// The task result contains a collection of <see cref="Artwork"/> instances associated with the specified portfolio.
    /// </returns>
    Task<IEnumerable<Artwork>> GetAllByPortfolioIdAsync(Guid portfolioId);

    /// <summary>
    /// Asynchronously adds a new artwork to a specified portfolio.
    /// </summary>
    ...
    /// <param name="description">A description of the artwork (optional).</param>
    /// <returns>
    /// A task that represents the asynchronous operation.
    /// </returns>
    ...
    /// <param name="description">The new description of the artwork (optional).</param>
    /// <returns>
    /// A task that represents the asynchronous operation.
    /// </returns>
